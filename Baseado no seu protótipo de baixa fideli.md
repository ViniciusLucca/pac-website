Baseado no seu protótipo de baixa fidelidade e na análise da identidade visual da PAC, o seu arquivo `DESIGN.md` seria um guia focado em brasilidade, acessibilidade e na estética de "colagem" cultural.

Abaixo está uma proposta de estrutura para o seu documento, utilizando a organização de seções do exemplo que você forneceu:
